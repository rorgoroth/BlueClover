...
import org.otacoo.chan.core.site.SiteBase;
...
public abstract class CommonSite extends SiteBase {
    ...
    public List<Board> getStaticBoards() {
        return staticBoards;
    }

    public org.otacoo.chan.core.site.http.HttpCallManager getHttpCallManager() {
        return httpCallManager;
    }

    @Override
    public Board board(String code) {
        return super.board(code);
    }

    @Override
    public Board createBoard(String name, String code) {
        return super.createBoard(name, code);
    }
